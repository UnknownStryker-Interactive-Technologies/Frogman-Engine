...
#include <C:/Users/leeho/Documents/GitHub/Frogman-Engine/SDK/CMake/../Framework/Include/FE/framework/file.hpp>
...
{
    ::FE::framework::framework_base::get_framework().get_method_reflection().register_task< ::FE::cpp_style_task<::FE::ECS, ::FE::entity<::FE::world>(::FE::ASCII* const)> >("::FE::world", &::FE::ECS::instanciate_entity<::FE::world>);
    ...
    ::FE::framework::framework_base::get_framework().get_method_reflection().register_task< ::FE::cpp_style_task<::FE::ECS, ::FE::entity<::FE::game>(::FE::ASCII* const)> >("::FE::game", &::FE::ECS::instanciate_entity<::FE::game>);

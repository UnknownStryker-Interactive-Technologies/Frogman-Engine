...
#include <C:/Users/leeho/Documents/GitHub/Frogman-Engine/SDK/CMake/../Core/Include/FE/deque.hxx>
...
#include <C:/Users/leeho/Documents/GitHub/Frogman-Engine/SDK/CMake/../Core/Include/FE/bitmask.hxx>
...
void load_reflection_data()
{
    ...
    ::FE::framework::framework_base::get_framework().get_method_reflection().register_task< ::FE::c_style_task<::nodes*(::nodes*)> >("construct ::nodes", &::std::construct_at<::nodes>);
    ::FE::framework::framework_base::get_framework().get_method_reflection().register_task< ::FE::c_style_task<void(::nodes*)> >("destruct ::nodes", &::std::destroy_at<::nodes>);

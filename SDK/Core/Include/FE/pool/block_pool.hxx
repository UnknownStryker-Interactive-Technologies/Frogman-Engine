...
namespace internal::pool
{
    ...
    public:
        ...
        constexpr static FE::size page_capacity_in_bytes = 4 * FE::one_KiB;//;
...
#if defined(_DEBUG_) || defined(_RELWITHDEBINFO_)
        FE_EXIT_IF(m_page_validation_table.find(l_page_base) == m_page_validation_table.end(), FE::ErrorCode::_FatalMemoryError_1XX_FalseDeallocation, "Fatal Error: the pointer '${%p@0}' does not belong to this block_pool instance located at '${%p@1}'.", pointer_p, this);

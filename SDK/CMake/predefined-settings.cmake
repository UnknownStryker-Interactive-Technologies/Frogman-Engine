...
IF(CMAKE_SYSTEM_NAME STREQUAL "Windows" AND CMAKE_SYSTEM_PROCESSOR STREQUAL "x64")
	...
	ADD_COMPILE_OPTIONS("$<$<COMPILE_LANGUAGE:C,CXX>:/D_FE_ON_WINDOWS_X86_64_;/D_ALLOWED_DIRECTORY_LENGTH_=32768;/D_FE_GDK_VERSION_=${FE_GDK_VERSION};/DENTT_NO_EXCEPTION;/DWIN32_LEAN_AND_MEAN;/D_HAS_EXCEPTIONS=0;/DNOMINMAX;/D_V143_=1>")
	...
	ADD_COMPILE_OPTIONS("$<$<COMPILE_LANGUAGE:C,CXX>:/std:c17;/Zc:__cplusplus;/WX;/W4;/GF;/Gy;/Oi;/GR;/utf-8;/MP;/wd4100;/w44062;/w44826>") #

	ADD_COMPILE_OPTIONS("$<$<AND:$<COMPILE_LANGUAGE:C,CXX>,$<CONFIG:DEBUG>>:/D_DEBUG_;/D_ENABLE_ASSERT_;/D_ENABLE_NEGATIVE_ASSERT_;/D_ENABLE_EXIT_;/D_ENABLE_LOG_;/D_ENABLE_LOG_IF_;/DENTT_ASSERT=FE_ASSERT>")
	ADD_COMPILE_OPTIONS("$<$<AND:$<COMPILE_LANGUAGE:C,CXX>,$<CONFIG:RELWITHDEBINFO>>:/D_RELWITHDEBINFO_;/D_ENABLE_ASSERT_;/D_ENABLE_NEGATIVE_ASSERT_;/D_ENABLE_EXIT_;/D_ENABLE_LOG_;/D_ENABLE_LOG_IF_;/DENTT_ASSERT=FE_ASSERT>")

...
{
    ::FE::framework::framework_base::get_framework().get_method_reflection().register_task< ::FE::cpp_style_task<::FE::framework::ECS, ::FE::entity<::FE::archetype_base>(::FE::ASCII* const, const ::FE::framework::initializer&)> >("::terrorist", &::FE::framework::ECS::instanciate_entity_from_initializer<::terrorist>);
    ...
    ::FE::framework::framework_base::get_framework().get_method_reflection().register_task< ::FE::cpp_style_task<::FE::framework::ECS, ::FE::entity<::FE::archetype_base>(::FE::ASCII* const, const ::FE::framework::initializer&)> >("::AK47", &::FE::framework::ECS::instanciate_entity_from_initializer<::AK47>);
    ...
    ::FE::framework::framework_base::get_framework().get_method_reflection().register_task< ::FE::cpp_style_task<::FE::framework::ECS, ::FE::entity<::FE::archetype_base>(::FE::ASCII* const, const ::FE::framework::initializer&)> >("::ak_ammo", &::FE::framework::ECS::instanciate_entity_from_initializer<::ak_ammo>);
    ...
    ::FE::framework::framework_base::get_framework().get_method_reflection().register_task< ::FE::cpp_style_task<::FE::framework::ECS, ::FE::entity<::FE::archetype_base>(::FE::ASCII* const, const ::FE::framework::initializer&)> >("::player", &::FE::framework::ECS::instanciate_entity_from_initializer<::player>);
    ...
    ::FE::framework::framework_base::get_framework().get_method_reflection().associate_system<health>(FE::SystemCallPhase::_WorldBegin, &::take_damage);
    ::FE::framework::framework_base::get_framework().get_method_reflection().associate_system<health>(FE::SystemCallPhase::_WorldBegin, &::take_damage2);
}

...
void load_reflection_data()
{
    ...
    ::FE::framework::framework_base::get_framework().get_method_reflection().register_task< ::FE::c_style_task<::base*(::base*)> >("construct ::base", &::construct<::base>);
    ::FE::framework::framework_base::get_framework().get_method_reflection().register_task< ::FE::c_style_task<void(::base*)> >("destruct ::base", &::destruct<::base>);
    ...
    ::FE::framework::framework_base::get_framework().get_method_reflection().register_task< ::FE::c_style_task<::lolbase*(::lolbase*)> >("construct ::lolbase", &::construct<::lolbase>);
    ::FE::framework::framework_base::get_framework().get_method_reflection().register_task< ::FE::c_style_task<void(::lolbase*)> >("destruct ::lolbase", &::destruct<::lolbase>);
    ::FE::framework::framework_base::get_framework().get_method_reflection().register_task< ::FE::c_style_task<::base*(::base*)> >("construct ::base", &::construct<::base>);
    ::FE::framework::framework_base::get_framework().get_method_reflection().register_task< ::FE::c_style_task<void(::base*)> >("destruct ::base", &::destruct<::base>);
}

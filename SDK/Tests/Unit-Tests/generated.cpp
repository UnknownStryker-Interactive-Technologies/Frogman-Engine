...
{
    ::FE::framework::framework_base::get_framework().get_method_reflection().register_task< ::FE::cpp_style_task<::FE::ECS, ::FE::entity<::FE::archetype_base>(::FE::ASCII* const, ::FE::initializer&)> >("::terrorist", &::FE::ECS::instanciate_entity_from_initializer<::terrorist>);
    ...
    ::FE::framework::framework_base::get_framework().get_method_reflection().register_task< ::FE::cpp_style_task<::FE::ECS, ::FE::entity<::FE::archetype_base>(::FE::ASCII* const, ::FE::initializer&)> >("::AK47", &::FE::ECS::instanciate_entity_from_initializer<::AK47>);
    ...
    ::FE::framework::framework_base::get_framework().get_method_reflection().register_task< ::FE::cpp_style_task<::FE::ECS, ::FE::entity<::FE::archetype_base>(::FE::ASCII* const, ::FE::initializer&)> >("::ak_ammo", &::FE::ECS::instanciate_entity_from_initializer<::ak_ammo>);
    ...
    ::FE::framework::framework_base::get_framework().get_method_reflection().register_task< ::FE::cpp_style_task<::FE::ECS, ::FE::entity<::FE::archetype_base>(::FE::ASCII* const, ::FE::initializer&)> >("::player", &::FE::ECS::instanciate_entity_from_initializer<::player>);
    ...
    ::FE::framework::framework_base::get_framework().get_method_reflection().register_task< ::FE::cpp_style_task<::FE::ECS, ::FE::component_view<::FE::component_base>(::FE::entity<::FE::archetype_base>)> >("::ak_magazine", &::FE::ECS::instanciate_component<::ak_magazine>);
    ...
    ::FE::framework::framework_base::get_framework().get_method_reflection().register_task< ::FE::cpp_style_task<::FE::ECS, ::FE::component_view<::FE::component_base>(::FE::entity<::FE::archetype_base>)> >("::health", &::FE::ECS::instanciate_component<::health>);
    ...
    ::FE::framework::framework_base::get_framework().get_method_reflection().register_task< ::FE::cpp_style_task<::FE::ECS, ::FE::component_view<::FE::component_base>(::FE::entity<::FE::archetype_base>)> >("::weapon", &::FE::ECS::instanciate_component<::weapon>);
    ...
    ::FE::framework::framework_base::get_framework().get_method_reflection().register_task< ::FE::cpp_style_task<::FE::ECS, ::FE::component_view<::FE::component_base>(::FE::entity<::FE::archetype_base>)> >("::speed", &::FE::ECS::instanciate_component<::speed>);

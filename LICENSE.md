...
5. The Work and the Derivative Works may not be used for training AI models or developing AI-relevant products without prior written permission from the Licensor. However, an exception can be made if the Licensor grants the permission to use the Work and the Derivative Works for training AI models or developing AI-relevant products.  
...
5. 저작물이나 파생 저작물을 **인공지능이나 그와 관련된 소프트웨어**를 **개발**할 때 사용되어서는 아니 된다. 다만, 원 저작자에게 허가를 받고 인공지능이나 그와 관련된 소프트웨어를 **개발**하기 위해 저작물이나 파생 저작물을 사용할 수 있다.
